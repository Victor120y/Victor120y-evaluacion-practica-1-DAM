        ...
        public void onBindViewHolder(@NonNull PacienteViewHolder holder, int position) {
            ...
            if (actionListener != null) {
                holder.btnEditar.setOnClickListener(v -> {
                    ...
                    android.app.AlertDialog alertDialog = new android.app.AlertDialog.Builder(holder.itemView.getContext(), R.style.CustomAlertDialog)
                    ...
                    // Cambia el color de los botones a azul
                    alertDialog.getButton(android.app.AlertDialog.BUTTON_POSITIVE)
                            .setTextColor(holder.itemView.getContext().getResources().getColor(R.color.blue));
